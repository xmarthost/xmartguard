...
export async function startHarness(overrides: Partial<Config> = {}): Promise<Harness> {
  ...
  const cfg: Config = { ...loadConfig({}), databaseUrl: TEST_DB, webDir: '', autoUpdateAgents: false, ipdbSync: false, ipdbFeeds: [], geoUrl: '', wpCoreSync: false, sigSync: false, aiTraining: false, ...overrides };
